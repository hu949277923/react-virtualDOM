...
const modifyDOM = (
  <div className="container">
    <h1>你好 Tiny React</h1>
    <h2 data-test="test heeee">(编码必杀技)</h2>
    <div>
      嵌套1 <div>嵌套 1.1</div>
    </div>
    {2 == 1 && <div>如果2和1相等渲染当前内容</div>}
...
function Headt (props) {
  return <div>11111  { props.title }<Demo/></div>
}
// TinyReact.render(<Headt title="hello bill"/>, root)

class Heat extends TinyReact.Component {
  constructor (props) {
    super(props)
  }
  render () {
...
// TinyReact.render(<Heat name="zhangsan" age = {30}/>, root)
